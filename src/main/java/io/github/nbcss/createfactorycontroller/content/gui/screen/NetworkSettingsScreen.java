...
public class NetworkSettingsScreen extends AbstractSimiContainerScreen<FactoryControllerMenu>
    ...
    private static final int NAME_X = 46, NAME_Y = 29, NAME_W = 138, NAME_H = 16;
    ...
    protected void init() {
        ...
        clearButton = new IconButton(panelX + 158, panelY + 64, AllIcons.I_TRASH);
        ...
        confirmButton = new IconButton(panelX + 180, panelY + 64, AllIcons.I_CONFIRM);
    ...
    private void renderNetworkIcon(GuiGraphics gfx, NetworkSettings settings, int x, int y) {
        ...
        gfx.fill(x, y, x + ICON_SIZE, y + ICON_SIZE, settings.backgroundColor());
